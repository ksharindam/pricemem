...
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "PriceMem"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "PriceMem"
...
!define BUILDDIR      "dist\pricemem"
!define QTBIN_DIR     "dist\pricemem\_internal\PyQt5\Qt5\bin"
!define QTPLUGINS_DIR "dist\pricemem\_internal\PyQt5\Qt5\plugins"
...
Section "MainSection" SEC01
  ...
  ;${registerExtension} "$INSTDIR\${PROG_EXEC}" ".pinv" "PriceMem Invoice"
SectionEnd
...
Section Uninstall
  ...
  ;${unregisterExtension} ".pinv" "PriceMem Invoice"
